...
snap(){
    ...
    espeak "Snap support package installed"
}

vsCode(){
    # visual studio code
    echo -e "\033[1;31m* Baixando snap Visual Studio Code *\e[0m" && sleep 1;
    sudo snap install --classic code && echo -e "\033[1;32m* Concluido *\e[0m" && sleep 1;
...
reactSupport(){    
    ...
    echo -e "\033[1;32m* Concluido *\e[0m" && sleep 1;
    espeak "React support tools installed"
    espeak "MySQL Workbench installed"
}
...
mySqlWorkbench(){
    ...
    echo -e "\033[1;32m* Concluido *\e[0m" && sleep 1;
    espeak "MySQL Workbencs installed"
}
